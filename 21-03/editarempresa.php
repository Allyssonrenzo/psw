...
<div class="caixa">
    ...
    <form action="mostraempresa.php" method="get">
        ...
        <p><input type="text" name="n" id="n" class="l5"  value="<?php echo $_GET['n'];   ?> "></p>
        </div>
        <div class="t1">
